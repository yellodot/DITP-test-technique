            ...
            <div class="fr-header__tools">
              <div class="fr-header__tools-links">
                ...
                <ul class="fr-links-group">
                  <li>
                    <a class="fr-link fr-fi-add-circle-line" href="#">
                      <img alt="home" src={HomeIcon}></img>Accueil
                    </a>
                  </li>
                  <li>
                    <a class="fr-link fr-fi-lock-line" href="#">
                      <img alt="news" src={NewsIcon}></img>Nouveautés
                    </a>
                  </li>
                  <li>
                    <a class="fr-link fr-fi-account-line" href="#">
                      <img alt="help" src={HelpIcon}></img>Centre d'aide
                    </a>
                  </li>
                  <li>
                    <a class="fr-link fr-fi-account-line" href="#">
                      <img alt="printer" src={PrinterIcon}></img>Imprimer
                    </a>
                  </li>
                </ul>
              </div>
